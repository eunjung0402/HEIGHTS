$(function(){
  ...
  // 브랜드 스와이퍼 1
  const brandSwiper1 = new Swiper(".brandSwiper1", {
    slidesPerView: "auto",
    spaceBetween: 10,
    freeMode: true,
    mousewheel: true,
  ...
  // 브랜드 스와이퍼 2
  const brandSwiper2 = new Swiper(".brandSwiper2", {
    slidesPerView: "auto",
    spaceBetween: 10,
    freeMode: true,
    mousewheel: true,
  ...
  // 랭킹 스와이퍼
  const rangkingSwiper = new Swiper(".rangkin_slide", {
    pagination: {
      el: ".pagination",
    },
    loop: true,
  ...
  const visualSwiper = new Swiper(".mobile_slide1", {
    slidesPerView: 1.2,
    centeredSlides: true,
    loop:true,
    spaceBetween: 8,
  ...
  const curationSwiper = new Swiper(".mobile_slide2", {
    slidesPerView: 1.2,
    loop:true,
  });

  // 모바일 사이즈로 변경시 신상품 스와이퍼
  const newProductSwiper = new Swiper(".mobile_slide3", {
    slidesPerView: 1.3,
    spaceBetween: 15,
    loop:true,
  });
  ...
  const magazineSwiper = new Swiper(".mobile_slide4", {
    slidesPerView: 1.2,
    spaceBetween: 15,
    loop:true,
  });
